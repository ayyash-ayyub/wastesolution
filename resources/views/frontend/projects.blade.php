...
@include('frontend.partials.head', [
    'title' => 'Projects — Dahana',
    'metaDescription' => 'Proyek Dahana Waste Management System',
    'metaAuthor' => 'Dahana'
])
</head>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6 relative">
                            <div class="me-lg-4">
                                ...
                                <h1 class="mb-2 wow fadeInUp" data-wow-delay=".2s">Our Projects</h1>
                ...
                <div class="container">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="relative wow fadeInRight" data-wow-delay=".0s">
                                <div class="hover overflow-hidden relative text-light">
                                    <a href="project-single.html" class="abs w-100 h-100 z-5"></a>
                                    <img src="images/projects/1.webp" class="hover-scale-1-1 w-100 wow scaleIn" data-wow-delay=".0s" alt="">
                                    ...
                                    <div class="abs z-2 top-0 w-100 hover-op-0">
                                        <div class="m-4">
                                            <div class="d-flex">
                                                <div class="me-5">
                                                    <h4 class="mb-1">Smart Waste Management</h4>
                        ...
                        <!-- project item begin -->
                        <div class="col-lg-4 col-md-6">
                            <div class="relative wow fadeInRight" data-wow-delay=".3s">
                                <div class="hover overflow-hidden relative text-light">
                                    <a href="project-single.html" class="abs w-100 h-100 z-5"></a>
                                    <img src="images/projects/2.webp" class="hover-scale-1-1 w-100 wow scaleIn" data-wow-delay=".3s" alt="">
                                    <div class="abs w-100 px-4 hover-op-1 z-4 hover-mt-40 abs-centered">
                                        <div class="mb-3">Delivering smart waste solutions for homes, businesses & industries to keeping communities clean and protecting the environment every day.</div>
                                    </div>
                                    <div class="abs bg-color z-2 top-0 w-100 h-100 hover-op-1"></div>
                                    <div class="abs z-2 top-0 w-100 hover-op-0">
                                        <div class="m-4">
                                            <div class="d-flex">
                                                <div class="me-5">
                                                    <h4 class="mb-1">Reduce Reuse Recycle</h4>
                        ...
                        <!-- project item begin -->
                        <div class="col-lg-4 col-md-6">
                            <div class="relative wow fadeInRight" data-wow-delay=".6s">
                                <div class="hover overflow-hidden relative text-light">
                                    <a href="project-single.html" class="abs w-100 h-100 z-5"></a>
                                    <img src="images/projects/3.webp" class="hover-scale-1-1 w-100 wow scaleIn" data-wow-delay=".6s" alt="">
                                    <div class="abs w-100 px-4 hover-op-1 z-4 hover-mt-40 abs-centered">
                                        <div class="mb-3">Delivering smart waste solutions for homes, businesses & industries to keeping communities clean and protecting the environment every day.</div>
                                    </div>
                                    <div class="abs bg-color z-2 top-0 w-100 h-100 hover-op-1"></div>
                                    <div class="abs z-2 top-0 w-100 hover-op-0">
                                        <div class="m-4">
                                            <div class="d-flex">
                                                <div class="me-5">
                                                    <h4 class="mb-1">Clean Green Initiative</h4>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="relative wow fadeInRight" data-wow-delay=".6s">
                                <div class="hover overflow-hidden relative text-light">
                                    <a href="project-single.html" class="abs w-100 h-100 z-5"></a>
                                    <img src="images/projects/4.webp" class="hover-scale-1-1 w-100 wow scaleIn" data-wow-delay=".6s" alt="">
                                    <div class="abs w-100 px-4 hover-op-1 z-4 hover-mt-40 abs-centered">
                                        <div class="mb-3">Delivering smart waste solutions for homes, businesses & industries to keeping communities clean and protecting the environment every day.</div>
                                    </div>
                                    <div class="abs bg-color z-2 top-0 w-100 h-100 hover-op-1"></div>
                                    <div class="abs z-2 top-0 w-100 hover-op-0">
                                        <div class="m-4">
                                            <div class="d-flex">
                                                <div class="me-5">
                                                    <h4 class="mb-1">Industrial Waste Management</h4>
                                                    <span>Louisiana</span>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="relative wow fadeInRight" data-wow-delay=".6s">
                                <div class="hover overflow-hidden relative text-light">
                                    <a href="project-single.html" class="abs w-100 h-100 z-5"></a>
                                    <img src="images/projects/5.webp" class="hover-scale-1-1 w-100 wow scaleIn" data-wow-delay=".6s" alt="">
                                    <div class="abs w-100 px-4 hover-op-1 z-4 hover-mt-40 abs-centered">
                                        <div class="mb-3">Delivering smart waste solutions for homes, businesses & industries to keeping communities clean and protecting the environment every day.</div>
                                    </div>
                                    <div class="abs bg-color z-2 top-0 w-100 h-100 hover-op-1"></div>
                                    <div class="abs z-2 top-0 w-100 hover-op-0">
                                        <div class="m-4">
                                            <div class="d-flex">
                                                <div class="me-5">
                                                    <h4 class="mb-1">Urban Clean-Up</h4>
                                                    <span>Oregon</span>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="relative wow fadeInRight" data-wow-delay=".6s">
                                <div class="hover overflow-hidden relative text-light">
                                    <a href="project-single.html" class="abs w-100 h-100 z-5"></a>
                                    <img src="images/projects/6.webp" class="hover-scale-1-1 w-100 wow scaleIn" data-wow-delay=".6s" alt="">
                                    <div class="abs w-100 px-4 hover-op-1 z-4 hover-mt-40 abs-centered">
                                        <div class="mb-3">Delivering smart waste solutions for homes, businesses & industries to keeping communities clean and protecting the environment every day.</div>
                                    </div>
                                    <div class="abs bg-color z-2 top-0 w-100 h-100 hover-op-1"></div>
                                    <div class="abs z-2 top-0 w-100 hover-op-0">
                                        <div class="m-4">
                                            <div class="d-flex">
                                                <div class="me-5">
                                                    <h4 class="mb-1">Marine Waste Cleanup</h4>
                                                    <span>Florida</span>
                                                </div>
                                            </div>
                                        </div>
